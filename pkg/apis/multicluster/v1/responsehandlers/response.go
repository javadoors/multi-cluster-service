...
// SendtatusBadGateway writes http.StatusForbidden.
func SendtatusBadGateway(resp *restful.Response, message string, err error) {
	logErrorInfo(err)

	resp.WriteHeaderAndEntity(http.StatusBadGateway, restful.ServiceError{
